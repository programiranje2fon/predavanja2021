...
public class Racun4 {
	...
	public Racun4(int brojArtikala) {
		...
		*/
		...
		stavkeRacuna = new Artikal[brojArtikala];
	...
	protected double izracunajUkupanIznos() {
		...
		for(int i=0; i<stavkeRacuna.length; i++) {
			if (stavkeRacuna[i] != null) {
				ukupanIznos = ukupanIznos + stavkeRacuna[i].izracunajIznos();
			}
		}
		return ukupanIznos;
	}
	...
	protected double izracunajProsecnuCenuArtikla() {
		...
		for(int i=0; i< stavkeRacuna.length; i++) {
			if (stavkeRacuna[i] != null) {
				suma = suma + stavkeRacuna[i].getJedinicnaCena();
			}
		}
...
*/
	...
	public String toString() {
		...
		for(int i=0; i<stavkeRacuna.length; i++) {
			if (stavkeRacuna[i] != null) {
				sb.append((i+1)+": "+stavkeRacuna[i].getNaziv() + 
							" | Jed. Cena: "+stavkeRacuna[i].getJedinicnaCena() +
							" | Kol: "+stavkeRacuna[i].getKolicina() ).append(System.lineSeparator());
			}
		}
